...
function Signup(){
  ...
  const unableoptions =[
    { label: "메밀",value:"1"},{ label: "밀",value:"2" },{ label: "대두",value:"3"},{ label:"호두",value:"4"},
    { label: "땅콩",value:"5"},{ label: "복숭아",value:"6" },{ label: "토마토",value:"7"},{ label:"돼지고기",value:"8"},
    { label: "난류(가금류)",value:"9"},{ label: "우유",value:"10" },{ label: "닭고기",value:"11"},{ label:"쇠고기(소고기)",value:"12"},
    { label: "새우",value:"13"},{ label: "고등어",value:"14" },{ label: "홍합",value:"15"},{ label:"전복",value:"16"},
    { label: "굴",value:"17"},{ label: "조개류",value:"18" },{ label: "게",value:"19"},{ label:"오징어",value:"20"},
    ...
    <div className="su-bg"style={{background:"#A8BA88"}}>
      <div className="su">
        ...
        <form onSubmit={(e)=>submit(e)}>
          <div class="d-flex justify-content-center">
            <label className="su-label"><span>아이디</span>
            <input onChange={(e)=>handle(e)} id="userid" value={data.userid} type="text" style={{width:320}}/></label>
          </div>
          <div class="d-flex justify-content-center">
            <label className="su-label"><span>비밀번호</span>
            <input onChange={(e)=>handle(e)} id="userpw" value={data.userpw} type="password" style={{width:320}}/></label>
          </div>
          <div class="d-flex justify-content-center">
            <label className="su-label"><span>성별</span>
              <select onChange={(e)=>handle(e)} id="sex" value={data.sex} style={{width:320,textAlign:"center"}}>
          ...
          <div class="d-flex justify-content-center">
            <label className="su-label"><span>나이</span>
              <select onChange={(e)=>handle(e)} id="age" value={data.age} style={{width:320,textAlign:"center"}} >
          ...
          <div class="d-flex justify-content-center">
            <button className="su-btn" class="btn btn-outline-dark">회원가입하기</button>
          </div>
        </form>
      </div>
    </div>
